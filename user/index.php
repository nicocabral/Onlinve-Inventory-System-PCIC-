...
if(!isset($_SESSION['username']) && !isset($_SESSION['password'])){
	header("location:../index");}else if ($_SESSION['usertype'] =='admin'){header("location:../adminCopy/index1");}else{?>
<?php include('includes/head.php');?>

<body class="hold-transition skin-blue layout-top-nav" style=" background-image:url(dist/img/boxed-bg.jpg); width:100%; height:100%; cursor:pointer;">
...
<?php unset($_SESSION['success_msg']);
	  unset($_SESSION['class']); } ?>
       <div class="row">
        <div class="col-md-9">
        <span style="font-size:26px; color: #000; font-weight:bold; font-family:'Comic Sans MS', cursive;"><img src="/PCIC/img/icon/report.png" width="45px"/> LIST OF AVAILABLE ITEMS FOR REQUEST</span>
       </div> </div>
      <hr />
           <iframe src="availablestocks_requestTable.php" class="form" height="700px;" width="100%" style="border-style:none;"></iframe><hr /></div></div>
          </div>
          <!-- /.box-body -->
        </div>
        <!-- /.box -->
