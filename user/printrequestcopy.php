...
<div class="col-lg-3">
<form method="post" action="printrequestcopyexcel">
<input type="hidden" name="printsel" value="<?php echo $_POST['printsel']?>" />
<input type="hidden" name="date" value="<?php echo $_POST['date']?>" />
<input type="hidden" name="dep" value="<?php echo $_SESSION['dep'];?>" />
<button type="submit" class="btn btn-success" data-toggle="tooltip" title="Export data to Excel">Export to Excel</button>
</form>
</div>
<div class="col-lg-1">
<a href="requisitionandissuanceslip_page" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;">Back</a><br />
</div></div><div class="col-lg-6"></div></div></div>
