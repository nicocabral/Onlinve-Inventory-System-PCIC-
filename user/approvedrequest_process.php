...
$id = intval($_GET['itemno']);
   ...
   $_SESSION['success_msg'] = '<img src="/PCIC/img/icons/ok2.ico" width="25px;"><strong>'.$itemname.' Request updated!</strong>';
    header("Location:risTable");
	$_SESSION['class'] = 'success';exit();}
	else
	{ $_SESSION['success_msg'] = '<img src="/PCIC/adminCopy/delete.png" width="25px;"> <strong> Sorry unable to process your request</strong>';
    header("Location:risTable");
