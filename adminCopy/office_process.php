...
include('includes/dbconn.php');
	if(isset($_POST['save'])){
		...
		if($mdep==0 && $elife==0){
			...
			$c = $amount - $a;
				...
				$b = 0;
				$c = 0;}
		$query = mysql_query("SELECT oid FROM office_ledgercard WHERE oid = '$eno'") or die (mysql_error());
	...
	$_SESSION['class'] = 'danger';
				...
				$sql = "INSERT INTO office_equipment VALUES(NULL,'$eno','$name','$des','$qty','$amount','$date','$elife','$svalue','$mdep')";
				$q = "INSERT INTO office_ledgercard VALUES(NULL,'$eno','$name','$date','$amount','$a','$b','$c','$svalue')";
