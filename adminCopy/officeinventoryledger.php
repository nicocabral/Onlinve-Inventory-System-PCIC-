...
<div class="col-lg-3">
<form method="post" action="officeinventoryledgerexcel">
...
<div class="col-lg-1">
<a href="officeTable" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;" data-placement="bottom">Back</a></div>
 </div>
...
<div style="text-align:center;">
          ...
          <?php
            ...
            <th style="width:auto;border:1px solid" colspan="2"><p style="font-size:8px;">Account Code:<br />
            									Property No.: <strong><?php echo $rows['oid'];?></strong><br />
