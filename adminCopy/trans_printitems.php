...
<div class="col-lg-3">
<form method="post" action="trans_printitemsexcel">
...
<div class="col-lg-1">
<a href="tTable" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;" data-placement="bottom">Back</a>
</div> </div>
...
<div style="text-align:center;">
          ...
          <thead style="border:solid 1px; font-size:12px;">
            ...
            <tr style="font-size:12px;border:solid 1px;">
                ...
                <td style="text-align:center;border:solid 1px;background-color:#F30; color:#FFF;"><?php echo number_format($r['paccumdep'],2,'.',',');?></td>
            ...
            <?php include('includes/dbconn.php');
                ...
                <td style="text-align:center;border:solid 1px;background-color:#F30; color:#FFF;"><?php echo number_format($row['paccumdep'],2,'.',',');?></td>
                ...
                <?php }}else{
                  ...
                  <?php
				$depreciation = "SELECT * FROM t_depreciated WHERE Year(date)>='$year' AND Month(date)<'$m'";
                ...
                <td style="text-align:center;border:solid 1px;background-color:#F30; color:#FFF;"><?php echo number_format($deprow['deplastm'],2,'.',',');?></td>
                ...
                <td style="color:#F30;border:solid 1px; text-align:center; font-weight:bold;"><?php echo number_format($t,2,'.',',');?></td>
                 ...
                 <td style="color:#F30;border:solid 1px;text-align:center; font-weight:bold;"><?php echo number_format($tmdep,2,'.',',');?></td>
                  <td style="color:#F30;border:solid 1px;text-align:center; font-weight:bold; background-color:#F30; color:#FFF;"><?php echo number_format($dep,2,'.',',');?></td>
