    ...
    <div class="container" style=" background-image:url(dist/img/boxed-bg.jpg); width:100%;">
      ...
      <section class="content">
        <div class="box box-default">
         <ol class="breadcrumb">
  			<li><a href="index1"><span class="glyphicon glyphicon-home"></span> Home</a></li>
              <li class="active"><span class="glyphicon glyphicon-object-align-left"></span> Stock</li>
...
<?php unset($_SESSION['success_msg']);
	  unset($_SESSION['class']); } ?>
            ...
            <!---------------------------------------------------------------------->
          <iframe src="/PCIC/adminCopy/app_Table.php" class="form" height="400px;" width="100%" style="border-style:none;"></iframe>
