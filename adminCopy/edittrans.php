...
<div class="panel panel-default" style="font-family:'Comic Sans MS', cursive;">
  <div class="panel-heading" style="background-color:#0C6; color:#FFF; font-size:14px;"><strong><span class="glyphicon glyphicon-edit"></span> EDIT TRANSPORTATION EQUIPMENT</strong></div>
  <div class="panel-body">
    ...
    function totalAmount(){
    	...
    	<form class="form-horizontal" method="post" action="t_editprocess">
        <?php include('includes/dbconn.php');
		$id = intval($_GET['id']);
		$query = mysql_query("SELECT * FROM transportation_equipment WHERE id = '$id'") or die (mysql_error());
		if(mysql_num_rows($query)>0){
			while($row=mysql_fetch_array($query)){ ?>
 <div class="col-lg-2">
 <a href="tTable" class="btn btn-danger btn-block">Back</a></div>
 <div class="col-lg-8">
  ...
  <input type="hidden" name="id" value="<?php echo $row['id'];?>" />
   <input type="hidden" name="idno" value="<?php echo $row['tid'];?>" />
 ...
 <div class="col-lg-12">
  ...
  <div class="col-xs-6 col-sm-6 col-md-6">
    ...
    <div class="form-group">
     <div class="col-lg-12">
      <textarea class="form-control" id="des" name="des" required> <?php echo $row['des'];?></textarea>
  </div>
  </div></div></div>
...
<div class="row">
  ...
  <div class="row">
   <div class="col-xs-6 col-sm-6 col-md-6">
    <center><label>SALVAGE AMOUNT</label></center>
     <div class="form-group">
  <div class="col-lg-12">
      <input type="number" step="any" class="form-control" id="samount"  name="samount" value="<?php echo $row['s_val'];?>" required readonly="readonly" placeholder="0.00">
   </div>
  </div></div>
  <div class="col-xs-6 col-sm-6 col-md-6">
  ...
  <div class="form-group">
  <div class="col-lg-12">
      <input type="number" step="any" class="form-control" id="mdep"  name="mdep" value="<?php echo $row['m_dep'];?>" required readonly="readonly">
      <?php }}?>
 </div>
  </div></div>
</div>
