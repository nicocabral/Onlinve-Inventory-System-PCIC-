...
<div class="panel panel-default" style="font-family:'Comic Sans MS', cursive;">
  <div class="panel-heading" style="background-color:#0C6; color:#FFF; font-size:14px;"><strong><span class="glyphicon glyphicon-edit"></span> EDIT EDP EQUIPMENT</strong></div>
  <div class="panel-body">
    ...
    function totalAmount(){
    	...
    	<form class="form-horizontal" method="post" action="office_editprocess">
        <?php include('includes/dbconn.php');
		$id = intval($_GET['id']);
		$query = mysql_query("SELECT * FROM office_equipment WHERE id = '$id'") or die (mysql_error());
		if(mysql_num_rows($query)>0){
			while($row=mysql_fetch_array($query)){ ?>
 <div class="col-lg-2">
 <a href="officeTable" class="btn btn-danger btn-block">Back</a></div>
 <div class="col-lg-8">
