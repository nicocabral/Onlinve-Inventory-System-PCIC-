...
$dis1 = 'peoaddressPrint';
$btnname = 'btnpeoaddress';}
	else {
$dis = 'printcheckAR_TRANSMITALexcelcopy';
$dis1 = 'printCKno';
$btnname = 'btncheckrangeaddress';
	}
...
<input type="hidden" name="peo" value="<?php echo @mysql_real_escape_string($_POST['address']);?>" />
<input type="hidden" name="from" value="<?php echo @mysql_real_escape_string($_POST['cknofrom']);?>" />
    <input type="hidden" name="to" value="<?php echo @mysql_real_escape_string($_POST['cknoto']);?>" />
