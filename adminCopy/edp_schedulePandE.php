...
<a href="edp" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;">Back</a>
 </div>
<br /><br />
...
<div style="text-align:center;">
          ...
          <thead>
            ...
            <?php include('includes/dbconn.php');
					$sql = "SELECT edp_ledgercard.*,edp_equipement.itemname,edp_equipement.e_no,edp_equipement.qty,edp_equipement.s_value, SUM(edp_ledgercard.accum_dep) as adtm ,SUM(edp_ledgercard.p_accumdep) as paccumdep FROM edp_ledgercard LEFT JOIN edp_equipement ON edp_ledgercard.eno = edp_equipement.e_no WHERE edp_ledgercard.date BETWEEN '$fm' AND '$m' GROUP by edp_ledgercard.eno  ";
                ...
                <td style="text-align:center;"><?php echo $row['s_value'];?></td>
                ...
                <td style="text-align:center;"><?php echo number_format($row['book_val'],2,'.','');?></td>
                </tr>
                <?php }}else{echo'<strong style="color:red;">NO AVAILABLE DATA IN DATABASE AS OF '.$m.'</strong>';}?>
                <tr>
                <td colspan="2" style="background-color:#039; color:#FFF; font-weight:bold; font-size:12px; text-align:center;">TOTAL</td>
