...
<?php unset($_SESSION['success_msg']);
 ...
 ?>
		...
		$status = 'Available';
		 echo '<span class="label label-success" style=" font-size:14px;"><strong>'.$status.'</strong></span>';?></th>
        <th style="text-align:center; width:auto;"><a href="#myModalupdatestock<?php echo $row['id'];?>" data-toggle="modal" data-target="#myModalupdatestock<?php echo $row['id'];?>"><span class="glyphicon glyphicon-edit" data-toggle="tooltip" title="Update"></span> </a> | <a href="#deleteModal<?php echo $row['id'];?>" data-toggle="modal" data-target="#deleteModal<?php echo $row['id'];?>"><span class="glyphicon glyphicon-trash" data-toggle="tooltip" title="Delete?"></span> </a></th>
        </tr>
