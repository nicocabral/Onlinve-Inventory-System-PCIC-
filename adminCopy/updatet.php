...
<div class="col-md-2">
    <div class="a_close"><a  href="tTable"  data-toggle="tooltip" title="Close" class="pull-right" ><span class="glyphicon glyphicon-remove"></span></a></div><br>
                                        </div>
                                    </div>
      </div>
      <div class="modal-body" style="font-size:16px;">
        
    	<form class="form-horizontal" method="post" action="tupdate_inventoryprocess">
   <div class="row">
 ...
 $q = mysql_query("SELECT date ,tid FROM transportation_ledgercard WHERE tid = '$id' order by date desc") or die (mysql_error());
 if($r = mysql_fetch_array($q)){
   ...
   <?php }
	$dateacuired = mysql_query("SELECT date, tid FROM transportation_ledgercard WHERE tid = '$id' GROUP by tid") or die (mysql_error());
