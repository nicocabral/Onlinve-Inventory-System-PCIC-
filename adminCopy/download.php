      ...
      <section class="content">
        <div class="box box-default">
          ...
          <div class="box-body">
            <div class="row">
        <div class="col-md-9">
        <span style="font-size:20px; color: #000; font-family:'Comic Sans MS', cursive;"><img src="/PCIC/img/icon/request.png" width="45px"/>Annual Procurement Plan - Uploaded files(AFD - CAD - MSD)</span>
       </div> </div><hr />
       <div class="row">
       <div class="col-lg-12">
       <div class="col-lg-6">
       <a href="deleteupload_process" class="btn btn-danger" data-toggle="tooltip" title="Clean the database upload files"><span class="glyphicon glyphicon-trash"></span> Delete Upload Files</a></div>
       <div class="col-lg-6">
           <?php 
...
<br />
                <a href="download.php?id=<?php echo urlencode($id); ?>" class="btn btn-default" data-toggle="tooltip" title="Download File?"><?php 
				
				echo urlencode($name).'&emsp;'. $timestamp;?></a><br />
                <?php
            }
        }
        mysql_close();?>
