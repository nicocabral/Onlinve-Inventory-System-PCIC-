...
<div class="col-md-2">
    <div class="a_close"><a  href="ffTable"  data-toggle="tooltip" title="Close" class="pull-right" ><span class="glyphicon glyphicon-remove"></span></a></div><br>
                                        </div>
                                    </div>
      </div>
      <div class="modal-body" style="font-size:16px;">
        
    	<form class="form-horizontal" method="post" action="ffupdate_inventoryprocess">
   <div class="row">
 ...
 $q = mysql_query("SELECT date ,ffid FROM ff_ledgercard WHERE ffid = '$id' order by date desc") or die (mysql_error());
 if($r = mysql_fetch_array($q)){?>
  ...
  <?php }
	$dateacuired = mysql_query("SELECT date, ffid FROM ff_ledgercard WHERE ffid = '$id' GROUP by ffid") or die (mysql_error());
