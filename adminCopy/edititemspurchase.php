  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="font-family:'Comic Sans MS', cursive;">
      <div class="modal-header" style="background-color:#0C3;">
       <div class="row">
        <div class="col-md-9">
        <span style="font-size:23px; color: #fff; font-weight:bold;"><img src="/PCIC/img/icon/addsupplier.png" width="45px"/> ADD ITEM</span>
       </div> 
<div class="col-md-2">
    <div class="a_close"><a  href="stock_pageTable"  data-toggle="tooltip" title="Close" class="pull-right" ><span class="glyphicon glyphicon-remove"></span></a></div><br>
	  ...
	  <input type="number" value="<?php echo $row['unit_cost'];?>" class="form-control" id="ucost" name="ucost" onkeyup="totalCost();" required />
      </div></div>
