...
<div class="col-lg-1">
<a href="requisitionandissuanceslip_page" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;">Back</a></div></div>
...
Office :&emsp;<?php echo '<strong>'.$office.'</strong>';?></td>
 ...
 ?>
        ...
        <td style="text-align:center; width:auto;border:solid 1px;"><?php echo $row['qty'];?></td>
        <td style="text-align:center; width:auto;border:solid 1px;"><?php echo $row['timestamp'];?></td>
