...
<center>
 <p style="font-size:12px;">
            ...
            <th style="width:auto;border:1px solid;" colspan="2"><p style="font-size:10px; text-align:left; font-weight:normal;">Account Code:<br />
            																			 Property No.: <strong style="color:red;"><?php echo $rows['e_no'];?></strong><br />
...
header("Content-Disposition: attachment; filename=.$name. EDP LEDGER Report.xls");
