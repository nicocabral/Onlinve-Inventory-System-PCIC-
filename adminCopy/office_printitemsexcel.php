...
<center>
 <p style="font-size:12px;">
               <strong>PHILIPPINE CROP INSURANCE CORPORATION</strong><br>
                ...
                <p style="color:#000080; font-size:12px;"><strong>Schedule of Property and Equipment</strong></p>
															...
															if($m==1){
																...
																}else if($m==10){$month='OCTOBER';}else if($m==11){$month='NOVEMBER';}else if($m==12){$month='DECEMBER';}	echo $month.'&nbsp;'.$year;?></strong> </p></center>
...
header("Content-Disposition: attachment; filename=.$month.$year. OFFICE PPE Report.xls");
