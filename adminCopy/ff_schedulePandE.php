...
<a href="furnitureandfixture_page" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;">Back</a>
 </div>
<br /><br />
...
<div style="text-align:center;">
          ...
          <thead>
            ...
            <?php include('includes/dbconn.php');
					$sql = "SELECT ff_ledgercard.*,fixtureandfurniture.itemname,fixtureandfurniture.ffid,fixtureandfurniture.qty,fixtureandfurniture.s_val, SUM(ff_ledgercard.accum_deptm) as adtm ,sum(ff_ledgercard.accum_deplm) as paccumdep FROM ff_ledgercard LEFT JOIN fixtureandfurniture ON ff_ledgercard.ffid = fixtureandfurniture.ffid WHERE ff_ledgercard.date BETWEEN '$fm' AND '$m' GROUP by ff_ledgercard.ffid ORDER by ff_ledgercard.date  ";
