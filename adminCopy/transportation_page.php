...
<div class="modal fade  bs-example-modal-lg" id="myModalledger" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="font-family:'Comic Sans MS', cursive;">
       ...
       <div class="row">
        <div class="col-md-9">
        <span style="font-size:23px; color: #fff; font-weight:bold;"><img src="/PCIC/img/icon/edit.png" width="50px"/> EDIT TRANSPORTATION LEDGERCARD</span>
       </div> 
<div class="col-md-2">
    <div class="a_close"><a  href="transportation_page"  data-toggle="tooltip" title="Close" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a></div><br>
                                        </div>
                                    </div>
      </div>
...
function showData(str) {
  ...
  xmlhttp.open("GET","getdata4.php?q="+str,true);
  xmlhttp.send();
}
...
<div class="row">
  <div class="col-md-6">
    ...
    <option>SELECT ITEM</option>
   	<option></option>
   <?php $s = mysql_query("SELECT * FROM transportation_equipment order by date_acquired") or die (mysql_error());
   if(mysql_num_rows($s)>0){
	   while($r = mysql_fetch_array($s)){
		   $isdate = new DateTime($r['date_acquired']);?>
	<option value="<?php echo $r['tid'];?>"><?php echo $isdate->format('M d, Y').'&emsp;'.$r['itemname'];?></option>	
    <?php }} else { echo '<option> No available records in database</option>';}?>
    </select></div>
  ...
  <span class="pull-right"><a  href="transportation_page"  data-toggle="tooltip" title="Close" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Close</a></span></div>
  </div>
      </div>
      ...
      <section class="content">
        <div class="box box-default" style="font-family:'Comic Sans MS', cursive;">
          ...
          <center><h3 style="color:#093;"><img src="/PCIC/img/icon/receiveditem.png" width="40px" /> <strong>PROPERTY AND EQUIPMENT</strong></h3>
    		  <p><strong style="color:#039"><img src="/PCIC/img/icon_png/a_truck_256.png" width="25px;" /> TRANSPORTATION PAGE</strong></p></center>
            ...
            <div class="col-lg-3">
                <a href="#myModalledger" data-toggle="modal" data-target="#myModalledger" class="btn btn-success"><span class="glyphicon glyphicon-hand-up"></span> Edit Ledger Card here</a>
            </div>
       <span id="btn-all" class="col-lg-12">

	 	<form class="form-horizontal" method="post" action="t_process">
    <script>
 ...
 <div class="col-lg-12">
	  ...
	  $sql = mysql_query("SELECT tid FROM transportation_equipment order by tid") or die (mysql_error());
	  $itemno =1;
...
<div class="col-lg-4"></div>
<div class="col-lg-4"></div>
<div class="col-lg-4"><a href="" data-toggle="tooltip" title="Print items?" class="pull-right"><img src="/PCIC/img/icon/printer.ico" width="50px;" /></a></div>
</div></div>
</form>
</span>
<!-----------------------------inventory-------------------------------->
...
<div class="col-lg-12">
<center>
<form class="form-inline" method="post" action="transportation_schedulePandE">
...
<?php unset($_SESSION['success_msg']);
  ...
  <iframe class="embed-responsive-item" width="100%;" height="700px;" style="border:hidden;" src="tTable"></iframe>
