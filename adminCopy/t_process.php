...
include('includes/dbconn.php');
	if(isset($_POST['save'])){
		...
		if($mdep==0 && $elife==0){
			...
			$c = $amount - $a;
				...
				$b = 0;
				$c = 0;}
		$query = mysql_query("SELECT tid FROM transportation_ledgercard WHERE tid = '$eno'") or die (mysql_error());
    ...
    header("Location:transportation_page");
	...
	$_SESSION['class'] = 'danger';
				...
				$sql = "INSERT INTO transportation_equipment VALUES(NULL,'$eno','$name','$des','$qty','$amount','$date','$elife','$svalue','$mdep')";
				$q = "INSERT INTO transportation_ledgercard VALUES(NULL,'$eno','$name','$date','$amount','$a','$b','$b','$svalue')";
