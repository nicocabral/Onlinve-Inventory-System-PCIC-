...
<a href="office_equipment_page" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;">Back</a>
 </div>
<br /><br />
...
<div style="text-align:center;">
          ...
          <thead>
            ...
            <?php include('includes/dbconn.php');
					$sql = "SELECT office_ledgercard.*,office_equipment.itemname,office_equipment.oid,office_equipment.qty,office_equipment.s_val, SUM(office_ledgercard.accum_deplm) as adtm ,sum(office_ledgercard.accum_deptm) as paccumdep FROM office_ledgercard LEFT JOIN office_equipment ON office_ledgercard.oid = office_equipment.oid WHERE office_ledgercard.date BETWEEN '$fm' AND '$m' GROUP by office_ledgercard.oid ORDER by office_ledgercard.date  ";
