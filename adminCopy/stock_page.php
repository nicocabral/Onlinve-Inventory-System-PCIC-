...
<?php unset($_SESSION['success_msg']);
      ...
      <div class="col-md-9" style="font-family:'Comic Sans MS', cursive;">
        	<button style="margin-left:1px;" class="btn btn-success" data-toggle="modal" data-target="#myModaladdstock"><span class="glyphicon glyphicon-plus-sign"></span> ADD STOCK</button>
           
            <a href="#myModal" data-toggle="modal" data-target="#myModal" class="btn btn-warning"><span class="glyphicon glyphicon-print"></span> Print/Export Data to Excel</a></div>
           
         	<iframe src="/PCIC/adminCopy/stock_pageTable.php" class="form" height="700px;" width="100%" style="border-style:none; margin-top:5px;"></iframe>
