...
<?php unset($_SESSION['success_msg']);
      ...
      <div class="col-md-6">
     <a href="deletereqpurpose" class="btn btn-danger" data-toggle="tooltip" title="Click me if you are done"><span class="glyphicon glyphicon-ok"></span> Done</a>
       </div>
		
         	<iframe src="/PCIC/adminCopy/availablestocks_requestTable.php" class="form" height="700px;" width="100%" style="border-style:none; margin-top:5px;"></iframe>
