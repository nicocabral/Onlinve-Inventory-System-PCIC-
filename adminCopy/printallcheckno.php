...
<div class="col-lg-3">
<form method="post" action="printallchecknoexcel">
	<input type="hidden" name="checknofrom" value="<?php echo intval($_POST['checknofrom']);?>" />
    <input type="hidden" name="checknoto" value="<?php echo intval($_POST['checknoto']);?>" />
   
    <button type="submit" class="btn btn-success" data-toggle="tooltip" title="Export data to Excel" data-placement="bottom" name="printcheckno">Export to Excel</button>
</form>
</div>
<div class="col-lg-1">
...
<div class="container" style="font-size:12px;">
 ...
 $to = intval($_POST['checknoto']);
 	...
 	$sql = "SELECT * FROM cf_inventory WHERE checkno BETWEEN '$from' AND '$to' order by checkno";
