...
<?php unset($_SESSION['success_msg']);
 ...
 <br />
       <form method="post" action="editcheck_process">
...
<input type="text" name="ckno" class="form-control" value="<?php echo $row['checkno'];?>" required/>
<input type="hidden" name="id" class="form-control" value="<?php echo $row['id'];?>" required/>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="ckdate" value="<?php echo $row['checkdate'];?>" required readonly="readonly">
  </div></div></div>
  <div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6">
   <div class="form-group ">
 ...
 <input type="number" step="any" name="dv_no" value="<?php echo $row['dvno'];?>" class="form-control" required/>
  </div></div>
