...
<div class="col-lg-3">
<form method="post" action="printcheckexcel">
...
<div class="col-lg-1">
<a href="getcheckdata" data-toggle="tooltip" title="Back to previous page" class="btn btn-danger" style="padding-left: 10px;" data-placement="bottom">Back</a></div>
</div>
...
<div class="container" style="font-size:12px;">
 ...
 ?>
		...
		$ckdate = new DateTime($row['checkdate']);
		echo $ckdate->format('M d, Y');?></th>
