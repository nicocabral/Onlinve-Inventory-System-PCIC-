...
<div class="modal fade  bs-example-modal-lg" id="myModalledger" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="font-family:'Comic Sans MS', cursive;">
       ...
       <div class="row">
        <div class="col-md-9">
        <span style="font-size:23px; color: #fff; font-weight:bold;"><img src="/PCIC/img/icon/edit.png" width="50px"/> EDIT FURNITIRE AND FIXTURE LEDGERCARD</span>
       </div> 
<div class="col-md-2">
...
function showData(str) {
  ...
  xmlhttp.open("GET","getdata3.php?q="+str,true);
  xmlhttp.send();
}
...
<div class="row">
  <div class="col-md-6">
    ...
    <option>SELECT ITEM</option>
   	<option></option>
   <?php $s = mysql_query("SELECT * FROM fixtureandfurniture order by date_acquired") or die (mysql_error());
   if(mysql_num_rows($s)>0){
	   while($r = mysql_fetch_array($s)){
		   $isdate = new DateTime($r['date_acquired']);?>
	<option value="<?php echo $r['ffid'];?>"><?php echo $isdate->format('M d, Y').'&emsp;'.$r['itemname'];?></option>	
  ...
  <span class="pull-right"><a  href="furnitureandfixture_page"  data-toggle="tooltip" title="Close" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Close</a></span></div>
  </div>
      </div>
      ...
      <section class="content">
        <div class="box box-default" style="font-family:'Comic Sans MS', cursive;">
          ...
          <center><h3 style="color:#093;"><img src="/PCIC/img/icon/receiveditem.png" width="40px" /> <strong>PROPERTY AND EQUIPMENT</strong></h3>
    		  <p><strong style="color:#039"><img src="/PCIC/img/icon_png/c_inventory_256.png" width="25px;" /> FURNITURE AND FIXTURES</strong></p></center>
       ...
       <span id="btn-all" class="col-lg-12">
	 	...
	 	<form class="form-horizontal" method="post" action="ff_process">
    <script>
 ...
 <div class="col-lg-12">
	  ...
	  $sql = mysql_query("SELECT ffid FROM fixtureandfurniture order by ffid") or die (mysql_error());
	  $itemno =1;
...
<div class="col-lg-12">
<center>
<form class="form-inline" method="post" action="ff_schedulePandE">
...
<?php unset($_SESSION['success_msg']);
  ...
  <iframe class="embed-responsive-item" width="100%;" height="700px;" style="border:hidden;" src="ffTable"></iframe>
